...
> `v1.4.14` 已正式发布，包含“新增设备”交互式教程和认证、升级、代理、预约链路稳定性修复。公网生产已完成 `v1.4.14` 切换并通过 API、Web、升级状态和静态资源版本核验；新部署固定使用 `v1.4.14` 标签。版本差异见 [版本矩阵](docs/VERSION_MATRIX.md)。
...
- [v1.4.14 发布说明](docs/RELEASE_NOTES_v1.4.14.md)
